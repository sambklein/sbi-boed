...
from sbi_bax.experiments.functional import run_full_experiment
...
def main(cfg: DictConfig):
    ...
    state = run_full_experiment(cfg, data, data.prior, nuisance_prior, acquisition_fn)

    # Save the final observation in the top level directory
    torch.save(state.data_obs, "data_obs.pt")
